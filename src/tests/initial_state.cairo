...
mod tests {
    ...
    fn success_fold_1_up() {
        ...
        dispatcher.fold(Direction::Up(()), 1);
        
        let mut grid = dispatcher.get_paper();
        assert_eq(grid.at(0), @('AE'.into()) , 'Wrong cell 1 init value');
        assert_eq(grid.at(1), @('BF'.into()) , 'Wrong cell 1 init value');
        assert_eq(grid.at(2), @('CG'.into()) , 'Wrong cell 2 init value');
        assert_eq(grid.at(3), @('DH'.into()) , 'Wrong cell 3 init value');
        assert_eq(grid.at(4), @('I'.into()) , 'Wrong cell 4 init value');
        assert_eq(grid.at(5), @('J'.into()) , 'Wrong cell 5 init value');
        assert_eq(grid.at(6), @('K'.into()) , 'Wrong cell 6 init value');
        assert_eq(grid.at(7), @('L'.into()) , 'Wrong cell 7 init value');        
    }
}